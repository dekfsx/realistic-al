...
def wide_resnet28_2(
    ...
    kwargs["width_per_group"] = 64 * 2
    n = (28 - 4) / 6
    assert pretrained is False  # There are no pretrained models on ImageNet available!
    return _resnet(
        "wide_resnet28_2", Bottleneck, [n, n, n, n], pretrained, progress, **kwargs
    )
